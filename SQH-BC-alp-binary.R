# generating data from Box-Cox for alpha in (0,1] using discrete covariate

library(numDeriv)


data_gen_bin_Wei=function(n0,n1,g1,g2,alpha,p00,p01,c0,c1){
...
b0_true=log((1/alpha_true)*((1/(p00_true^alpha_true))-1))
b1_true=log((1/alpha_true)*((1/(p01_true^alpha_true))-1))-b0_true
...
for(i in 1:n){
  ...
  data=data_gen_bin_Wei(n0,n1,g1_true,g2_true,alpha_true,p00_true,p01_true,c0,c1)
